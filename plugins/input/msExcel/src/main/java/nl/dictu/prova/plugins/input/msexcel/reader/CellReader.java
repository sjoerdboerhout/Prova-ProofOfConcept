...
public class CellReader {
     ...
     * 
     * The dateFormat argument is used to format possible date values. Once the dateFormat is set for this instance of
     * CellReader, it is used again until overwritten or set back to 'null'.
     *
     * @param cell
     *            Spreadsheet cell to be evaluated
    ...
    /**
     * Assuming the given cell contains a formula, this method tries to evaluate the formula. When evaluation fails, it
     * tries to return the cached result from the last time the formula was evaluated.
     *
     * @param cell
    ...
    private String evaluateFormula(Cell cell) throws Exception {
        ...
        try {
            ...
            case Cell.CELL_TYPE_ERROR:
                LOGGER.warn(LOG_PREFIX + "formula couldn't not be evaluated. Returning cached result. ({})",
                        () -> getErrorString(cell));
    ...
    /**
     * Assuming the given cell contains a formula, this method returns the cached result of the formula from the last
     ...
     *
     * @param cell
     *            Cell containing the boolean value
     ...
     *
     * @param cellValue
     *            CellValue containing the boolean value
     * @return String value of the boolean cell value
     */
     ...
     *
     * @param cell
     *            Cell containing the numeric value
     ...
     *
     * @param d
     *            Double representing the numeric value
     * @return String value of the numeric cell value
     */
     ...
     *
     * @param cell
     *            Cell containing the date value
     ...
     *
     * @param cell
     *            Cell containing the error value
    ...
    /**
     * Checks if the given cell contains a key value. A value is a key if it is surrounded by curly brackets.
     *
     * @param cell
     *            Cell which might contain a key value
    ...
    /**
     * Checks if the given string contains a key value. A value is a key if it is surrounded by square brackets.
     *
     * @param cellContent
     *            String which might contain a key value
    ...
    /**
     * Checks if the given cell contains a tag value. A value is a tag if it is surrounded by square brackets.
     *
     * @param cell
     *            Cell which might contain a tag value
    ...
    /**
     * Checks if the given string contains a tag value. A value is a tag if it is surrounded by square brackets.
     *
     * @param cellContent
     *            String which might contain a tag value
    ...
    /**
     * Extracts the tag name from a cell. For example if the cell contains "[TAG]", "TAG" is returned.
     *
     * @param cell
     *            Cell containing the tag value
     * @return key name
     */
    ...
    /**
     * Extracts the tag name from a string. For example if the string contains "[TAG]", "TAG" is returned.
     *
     * @param cellContent
