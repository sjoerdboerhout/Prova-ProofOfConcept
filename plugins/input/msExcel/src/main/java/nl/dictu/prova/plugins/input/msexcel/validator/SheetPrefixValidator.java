...
/**
 * Checks if a sheet has a name with a valid prefix to be considered as the starting point of a new test case. All
 * characters up to but not including the first underscore are assumed to be the prefix of the sheet name.
 * <p>
 * Currently allowed prefixes: - WEB: web test - SH: shell test - SOAP: testing on SOAP
 *
...
public class SheetPrefixValidator {
    ...
    /**
     * Check if the name of the given sheet contains a prefix. If a prefix is found return it. Otherwise return NULL.
     * 
     * @param sheet
     * @return
     */
