...
public class MsExcel implements InputPlugin {
    ...
    /**
     * Set the root location of the test scripts and validate it can be read correctly.
     */
    @Override
    public void setTestRoot(String newTestRoot, String projectName) throws Exception {
        try {
            ...
            if (!testRoot.isDirectory()) {
                ...
                testRoot = new File(testRunner.getPropertyValue(Config.PROVA_DIR) + System.getProperty("file.separator")
                        + newTestRoot);
            }
            ...
            testRoot = new File(testRunner.getPropertyValue(Config.PROVA_TESTS_ROOT)
    ...
    public void loadTestCase(TestCase testCase) throws Exception {
        try {
            ...
            TestCaseBuilder testCaseBuilder = new TestCaseBuilder(testRunner.getPropertyValue(Config.PROVA_TESTS_ROOT),
                    this.testRunner);
