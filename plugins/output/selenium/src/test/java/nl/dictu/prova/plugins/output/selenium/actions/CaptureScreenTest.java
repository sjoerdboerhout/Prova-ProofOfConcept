...
public class CaptureScreenTest
{
  ...
  /**
   * Test of execute method, of class CaptureScreen.
   */
  @Test
  public void testExecute()
  {
    try
    {
      ...
      CaptureScreen instance = new CaptureScreen(selenium);
      File picture = new File(file.substring(0, file.lastIndexOf(File.separator)));
      System.out.println("Storing screenshot at " + picture.getAbsolutePath());
      instance.setAttribute("FILENAME", picture.getAbsolutePath() + "\\");
