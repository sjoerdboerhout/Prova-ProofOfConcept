...
public class SelectDropDownTest
{
  ...
  /**
   * Test of execute method, of class SelectDropDown.
   */
  @Test
  public void testExecute()
  {
    System.out.println("execute");
    SelectDropDown instance = new SelectDropDown(selenium);
    instance.setAttribute("XPATH", "//select[@id='dropdown']");
    instance.setAttribute("SELECT", "bmw");
