...
public class TestSuiteTest {
    ...
    public static void oneTimeSetUp() {
        ...
        /*
         * Create virtual structure of test suites and test cases: Root test suite:testRoot 0:TC: Shl-00 0:TC: Web-00
         * 
         * 0:TS: TestSuite-00 1: TC: Shl-00-01 1: TC: Web-00-01
         * 
         * 1: TS: TestSuite-01-01 2: TC: Shl-01-01-01 2: TC: Web-01-01-01 2: TC: Shl-01-01-02 2: TC: Web-01-01-02
         * 
         * 2: TS: TestSuite-01-01-01 3: TC: Shl-01-01-01-01 3: TC: Web-01-01-01-01
         * 
         * 2: TS: TestSuite-01-01-02 3: TC: Shl-01-01-02-01 3: TC: Web-01-01-02-01
         * 
         * 1: TS: TestSuite-01-02 2: TC: Shl-01-02-01 2: TC: Web-01-02-01 2: TC: Shl-01-02-02 2: TC: Web-01-02-02
         * 
         * 2: TS: TestSuite-01-02-01 3: TC: Shl-01-02-01-01 3: TC: Web-01-02-01-01
         * 
         * 2: TS: TestSuite-01-02-02 3: TC: Shl-01-02-02-01 3: TC: Web-01-02-02-01
         */
    ...
    /**
     * Debug function used for displaying the test tree of test suites and test cases used in this class. Prints a line
     * with <level>x space, <name> and line end.
     * 
     * @param level
     * @param name
     */
    ...
    /**
     * Debug function used for displaying the test tree of test suites and test cases used in this class. Loops
     * recursively through the tree of test suites and test cases.
     * 
     * @param rootTestSuite
     * @param level
     */
    ...
    /*
     * Issue ID: PROVA-32 Requirement: Each child test suite must be unique to prevent a loop
     * 
    ...
    /*
     * Issue ID: PROVA-32 Requirement: Each test suite can have no or 1 parent.
     * 
    ...
    /*
     * Issue ID: PROVA-32 Requirement: Each test suite can have 0...* child test suites.
     * 
    ...
    /*
     * Issue ID: PROVA-32 Requirement: Prevent a loop in the test suite tree
     * 
     ...
     * Issue ID: PROVA-32 Requirement: Prevent a loop in the test suite tree
     * 
     * Check recursively all number of child test suites if a specific test suite doesn't already exists.
     */
    @Test
