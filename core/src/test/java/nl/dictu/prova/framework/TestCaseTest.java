...
public class TestCaseTest
{
  ...
  /*
   * Issue ID:    PROVA-32
   * Requirement: Unique identifier per test case which is not empty
   * 
  ...
  /*
   * Issue ID:    PROVA-X
   * Requirement: Each test has a status Not run, blocked, passed or failed
   * 
  ...
  /*
   * Issue ID:    PROVA-X
   * Requirement: Each test has a summary for communicating the current 
   *              test status
   * 
  ...
  /*
   * Issue ID:    PROVA-X
   * Requirement: Each test has a priority reference
   * 
  ...
  /*
   * Issue ID:    PROVA-X
   * Requirement: Each test has an priority
   * 
