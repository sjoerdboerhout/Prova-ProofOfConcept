...
/**
 * Handles the Prova function 'validate element' to check if the given element is (not) available on the web page.
 * 
...
public class ValidateElement extends TestAction {
    ...
    public String toString() {
        return ("'" + this.getClass().getSimpleName().toUpperCase() + "': Validate that element '" + xPath.getValue()
                + "' " + (exists.getValue() ? "does" : "doesn't ") + "exist. " + "TimeOut: " + timeOut.getValue());
    }
}
