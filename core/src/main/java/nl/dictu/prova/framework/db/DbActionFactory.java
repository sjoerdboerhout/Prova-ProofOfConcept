...
public class DbActionFactory implements ActionFactory {
    ...
    public TestAction getAction(String name) throws Exception {
        ...
        case ACTION_PROCESSDBRESPONSE:
            return new ProcessDbResponse();
        case ACTION_SETDBPROPERTIES:
            return new SetDbProperties();
        case ACTION_SETDBPOLLPROPERTIES:
            return new SetDbPollProperties();
        case ACTION_SETQUERY:
            return new SetQuery();
        case ACTION_EXECUTEDBTEST:
            return new ExecuteDbTest();
        case ACTION_POLLFORDBRESULT:
            return new PollForDbResult();
        }
