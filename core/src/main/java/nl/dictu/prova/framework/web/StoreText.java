...
class StoreText extends TestAction {
    ...
    public void setAttribute(String key, String value) throws Exception {
        ...
        case ATTR_TIMEOUT:
            timeout = new TimeOut(Integer.parseInt(value));
            break;
        case ATTR_REGEX:
            regex = value.trim();
            break;
    ...
    public void execute() throws Exception {
        ...
        this.testRunner.getWebActionPlugin().doStoreText(xPath.getValue(), regex, inputtext, name,
                new Double(timeout.getValue()));
    }
