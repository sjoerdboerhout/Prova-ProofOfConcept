...
/**
 * Handles the Prova function 'capture screen' to save a screendump of the current view.
 * 
...
public class CaptureScreen extends TestAction {
    ...
    public String toString() {
        return ("'" + this.getClass().getSimpleName().toUpperCase() + "': Save a screendump to file '"
                + fileName.getValue() + "'");
    }
}
