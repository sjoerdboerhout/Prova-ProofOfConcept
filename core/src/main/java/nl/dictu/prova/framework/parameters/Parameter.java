...
public abstract class Parameter {
    ...
    protected String parseString(String value, Boolean trimValue, Boolean nullAsEmpty) throws Exception {
        try {
            LOGGER.trace("Parse string '{}', Trim: {}, NullAsEmpty: {}", () -> value, () -> trimValue,
                    () -> nullAsEmpty);
    ...
    protected Boolean validateString(String value, Integer minLength, Integer maxLength) {
        try {
            LOGGER.trace("Validate string '{}'. Min length: {}, Max length: {}", () -> value, () -> minLength,
                    () -> maxLength);
    ...
    protected Boolean validateInteger(Integer value, Integer minValue, Integer maxValue) {
        LOGGER.trace("Validate integer '{}'. Min: {}, Max: {}", () -> value, () -> minValue, () -> maxValue);
        try {
            if (value == null)
                throw new NullPointerException("Value 'null' is not allowed.");
    ...
    /**
     * Parses the string <value> as a boolean. The boolean returned represents the value true if the string argument is
