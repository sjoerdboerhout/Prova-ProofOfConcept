...
/**
 * Contains all the data of a test case including a list of all actions that are part of this test.
 * 
...
public class TestCase {
    ...
    /**
     * Update the test status from external source. For example when the test is blocked by another tests failure
     * 
     * @param status
     */
    ...
    /**
     * Set a summary for this test. Usefull when the test could not be completed.
     * 
     * @param testSummary
     */
                ...
                for (TestAction testAction : testActions) {
                    ...
                    try {
                        ...
                        if (this.testRunner.getPropertyValue("prova.flow.failon.actionfail").equalsIgnoreCase("true")) {
                            if (this.testRunner.getPropertyValue("prova.flow.failon.testfail").equalsIgnoreCase("false")
    ...
    /**
     * Clear all test cases when the test case is executed. This to minimize memory usage.
     */
    ...
    public String toString() {
        return String.format("ID: %s (Setup: %d, Actions: %d, Teardown: %d)", id, this.setUpActions.size(),
                this.testActions.size(), this.tearDownActions.size());
    }
}