...
public class WebActionFactory implements ActionFactory {
    ...
    public TestAction getAction(String name) throws Exception {
        ...
        case ACTION_CAPTURESCREEN:
            return new CaptureScreen();
        case ACTION_CLICK:
            return new Click();
        ...
        case ACTION_SLEEP:
            return new Sleep();
        case ACTION_STORETEXT:
            return new StoreText();
        case ACTION_SWITCHFRAME:
            return new SwitchFrame();
        case ACTION_SWITCHSCREEN:
            return new SwitchScreen();
        case ACTION_VALIDATEELEMENT:
            return new ValidateElement();
        case ACTION_VALIDATETEXT:
            return new ValidateText();
        case ACTION_WAITFORELEMENT:
