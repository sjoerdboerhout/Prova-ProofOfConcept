...
public class Config
{
  ...
  public final static String PROVA_PLUGINS_OUT_WEB_BROWSER_RESOLUTION       = "prova.plugins.out.web.browser.resolution";   // String,	  Browser Resolution width x height with x as separator
  public final static String PROVA_PLUGINS_OUT_WEB_BROWSER_PROXY            = "prova.plugins.out.web.browser.proxy";        // String,	  Browser Proxy
  public final static String PROVA_PLUGINS_OUT_WEB_BROWSER_FF_USEMARIONETTE = "prova.plugins.out.web.browser.ff.usemarionette"; // String Use marionette for newer firefox
